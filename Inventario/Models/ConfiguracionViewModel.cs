...
namespace Inventario.Models
{
    public class ConfiguracionViewModel
    {
        ...
        [Required(ErrorMessage = "Empresa/Razón Social requerida.")]
        [MaxLength(100)]
        ...
        [MaxLength(50, ErrorMessage = "El correo no puede ser mayor a 50 caracteres.")]
        ...
        //[MaxLength(3, ErrorMessage = "El puerto no puede tener sobrepasar 3 digitos.")] <- Ojo con esto, dara error en la vista 
