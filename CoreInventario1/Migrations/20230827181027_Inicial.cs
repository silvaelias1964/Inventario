        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatNombreCategoria = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CatDescripcion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CliCodigo = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PrvCodigo = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PrdCodigo = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    ...
                    PrdCantPorUnidad = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
